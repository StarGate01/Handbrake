...
DEVICE=attiny85
AVRDUDE = /mnt/c/Program\ Files\ \(x86\)/Arduino/hardware/tools/avr/bin/avrdude.exe -C "C:\\Program Files (x86)\\Arduino\\hardware\\tools\\avr\\etc\\avrdude.conf" -c usbasp -P usb -p $(DEVICE)
